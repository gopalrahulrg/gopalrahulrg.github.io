...
<div style="text-align: justify"><p>The clusters obtained from unsupervised learning are</p>
  ...
  <ul>
  <li>Cluster 0: West/South West Bangalore with low restaurant densities;</li>
  <li>Cluster 1: South Bangalore with low restaurant densities;</li>
  <li>Cluster 2: East Bangalore with many neighborhoods having medium restaurant densities.</li>
  <li>Cluster 3: North Bangalore with low restaurant densities;</li>
  <li>Cluster 4: Central Bangalore - North Side with medium restaurant densities;</li>
  <li>Cluster 5: Central Bangalore - South Side with medium to high restaurant densities.</li>
</ul>

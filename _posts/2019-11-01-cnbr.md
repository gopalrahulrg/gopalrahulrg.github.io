...
<div style="text-align: justify"><p>One of the most common unsupervised learning, namely the K-means algorithm was then used to cluster the neighborhoods. The algorithm was run with different cluster numbers to try and identify the optimal number for learning.</p>
...
<div style="text-align: justify"><p>The neighborhoods were then classified into either <b>"low"</b>, <b>"medium"</b> and <b>"high"</b> categories depending on whether they had fewer than 20, between 20 and 39 and at least 40 restaurants respectively.</p>

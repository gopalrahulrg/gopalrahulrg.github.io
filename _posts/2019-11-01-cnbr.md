...
<div style="text-align: justify">One hot encoding was then carried out to separate and group venue categories for each neighborhood.</p> 

<div style="text-align: center"><img src="{{ site.url }}{{ site.baseurl }}/assets/images/cnbr/cnbr_5.jpg">
  
<p></p>

<div style="text-align: justify">It was noticed that <b>over 2000 venues</b> were classified as <b>restaurants</b>. The count of the total number of restaurants was then computed and combined together into a dataframe with latitude and longitude values for each neighborhood for clustering.</p>

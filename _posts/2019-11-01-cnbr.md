...
<div style="text-align: justify"><p>Foursquare returned over <b>6000</b> venues for all neighborhoods except in Agara which did not return any search results.</p> A Word Cloud was then produced to filter out and highlight popular or trending venues based on frequency of occurrence.
